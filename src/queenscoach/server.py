...
INSTRUCTIONS = (
    ...
    "Every time in a response is Eastern time (America/New_York) in ISO 8601, with "
    "the offset in effect on that date: -04:00 during daylight saving time, -05:00 "
    "otherwise. Coordinates are WGS84 decimal degrees. "
    "The timetable covers only the dates CATS has published, which each "
